package org.icet.demo.controller.admin.removeSection.removeProduct;
...
public class removeProductController implements Initializable {
    public AnchorPane adminRemoveProductAnchor;
    ...
    public void registerBtn(ActionEvent actionEvent) throws IOException {
        ...
        adminRemoveProductAnchor.getChildren().clear();
        adminRemoveProductAnchor.getChildren().add(load);
    }
