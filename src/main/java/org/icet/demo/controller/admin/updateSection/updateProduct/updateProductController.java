package org.icet.demo.controller.admin.updateSection.updateProduct;
...
public class updateProductController implements Initializable {
    ...
    public AnchorPane adminUpdateProductAnchor;
    ...
    public void registerBtn(ActionEvent actionEvent) throws IOException {
        ...
        adminUpdateProductAnchor.getChildren().clear();
        adminUpdateProductAnchor.getChildren().add(load);
    }
